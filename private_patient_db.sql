...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 14, 2026 at 07:30 AM
...
--
CREATE DATABASE IF NOT EXISTS `private_patient_db` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `private_patient_db`;
...
(185, 1, 'admin', 'System Administrator', 'Administrator', 'LOGOUT', 'User logged out of the system.', '2026-09-14 03:52:14'),
(186, 1, 'admin', 'System Administrator', 'Administrator', 'LOGIN', 'User logged into the system.', '2026-09-14 05:01:14'),
(187, 1, 'admin', 'System Administrator', 'Administrator', 'LABORATORY', 'Added laboratory record: 0004 - JOHN JACOB BONIFACIO DAVID - 5 test(s) - 2026-09-14', '2026-09-14 05:09:08'),
(188, 1, 'admin', 'System Administrator', 'Administrator', 'LABORATORY', 'Updated laboratory result: 0004 - JOHN JACOB BONIFACIO DAVID - CREATININE - 2026-09-14', '2026-09-14 05:09:28'),
(189, 1, 'admin', 'System Administrator', 'Administrator', 'LABORATORY', 'Deleted laboratory record: 0004 - JOHN JACOB BONIFACIO DAVID - CREATININE - 2026-09-14', '2026-09-14 05:09:56');
...
(150, 21, '2026-09-14', 'FASTING BLOOD SUGAR', '95', '', '', '', '2026-09-14 05:09:08', 'WITHIN_FACILITY', 'DCMD CLINIC'),
(152, 21, '2026-09-14', 'HEMOGLOBIN', '14.0', '', '', '', '2026-09-14 05:09:08', 'WITHIN_FACILITY', 'DCMD CLINIC'),
(153, 21, '2026-09-14', 'HEMATOCRIT', '42', '', '', '', '2026-09-14 05:09:08', 'WITHIN_FACILITY', 'DCMD CLINIC'),
(154, 21, '2026-09-14', 'WBC COUNT', '250', '', '', '', '2026-09-14 05:09:08', 'WITHIN_FACILITY', 'DCMD CLINIC');
...
DROP TABLE IF EXISTS `prescription_headers`;
